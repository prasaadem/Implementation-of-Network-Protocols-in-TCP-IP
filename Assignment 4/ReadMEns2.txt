...
Developed by: Sathyajit Kulkarni and Satya Aditya

Architecture:
- Modular programming, includes well commented lines to describe functionality.

Usage:
ns filename.tcl <TCP type> <Case number>
Example usage: 
ns ns2.tcl VEGAS 2
ns ns2.tcl SACK 3
...
Simulation:
Simulation was run for 400ms and the throughput and relative throughput was put in the files output1.tr, output2.tr and output3.tr.
